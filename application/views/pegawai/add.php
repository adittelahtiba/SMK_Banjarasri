        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <form class="form-material" action="<?= base_url('Pegawai/addsave'); ?>" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="date" class="form-control" id="Tanggalahir" name="Tanggalahir" value="<?= set_value('Tanggalahir'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="form-control" name="Jk" id="Jk">
                                    ...
                                    <option value="L" <?= set_select('Jk', 'L'); ?>>Pria</option>
                                    <option value="P" <?= set_select('Jk', 'P'); ?>>Wanita</option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" id="Tugastambah" name="Tugastambah" value="<?= set_value('Tugastambah'); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="form-control" name="Status" id="Status">
                                    <option value="">--Pilih--</option>
                                    <option value="GTY" <?= set_select('Status', 'GTY'); ?>>GTY</option>
                                    <option value="GTT" <?= set_select('Status', 'GTT'); ?>>GTT</option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="form-control" name="Level" id="Level">
                                    <option value="0" <?= set_select('Level', '0'); ?>>Level 0 (Guru)</option>
                                    <option value="1" <?= set_select('Level', '1'); ?>>Level 1 (Bursa Kerja Khusus)</option>
                                    <option value="2" <?= set_select('Level', '2'); ?>>Level 2 (Pks. Hubin)</option>
                                    <option value="3" <?= set_select('Level', '3'); ?>>Level 3 (Kepala Sekolah)</option>
                                </select>
