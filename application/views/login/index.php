    ...
    <section id="wrapper" class="new-login-register">
        <div class="lg-info-panel">
            <div class="inner-panel">
                <a href="<?= site_url('Dashboard'); ?>" class="p-20 di"><img src="<?= base_url('assets/BackEnd/') ?>plugins/images/admin-logo-dark.png" height="45"></a>
            </div>
        </div>
        <div class="new-login-box">
            <div class="white-box">
                <h3 class="box-title m-b-0">Form Login</h3>
                <small>Untuk login, isi form di bawah ini</small>

                <form class="form-horizontal new-lg-form" id="loginform" method="post" action="<?= base_url('Login'); ?>">
                    <?= $this->session->flashdata('message'); ?>
                    <div class="form-group  m-t-20">
                        <div class="col-xs-12">
                            <label for="inputnama">ID/NIP/NIS</label>
                            <input class="form-control" type="text" name="id" value="<?= set_value('id'); ?>" placeholder="ID/NIP/NIS">
                ...
                <form class="form-horizontal" id="recoverform" method="post" action="<?= base_url('lupapassword/kirim_link'); ?>">
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <h3>Memulihkan Password</h3>
                            <p class="text-muted">Masukan ID/NIS/NIP anda, intruksi akan dikirim melalui email! </p>
                        </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control" type="number" required="" name="id" placeholder="ID/NIS/NIP">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
                            <a href="<?= base_url(); ?>" id="to-recover" class="text-dark pull-right"><i class="fa fa-lock m-r-5"></i> Login?</a>
                        </div>
                    </div>
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
