...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <form class="form-material" action="<?= base_url('Kelas/editsimpan/') . $siswa['id'] . "/" . $no; ?>" method="post">
                    ...
                    <div class="form-group col-md-12 white-box">
                        ...
                        <a style="color: white" href="<?= base_url('Kelas/kelas/') . $no; ?>" type="button" class="btn btn-inverse waves-effect waves-light m-r-10">
